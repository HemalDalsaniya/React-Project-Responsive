...
const Chat = ({ onClose, isChatOpen, setIsChatOpen }) => {
         ...
         ${isChatOpen ? 'z-50 opacity-100' : 'z-0'}`}>
                ...
                <div className="bg-white rounded-lg mx-3 mt-5 p-2 cursor-pointer">
                    <div className="p-1 rounded-md w-full flex justify-between">
                        <div className="flex bg-zinc-100 w-10 h-10 justify-center items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" role="img" aria-hidden="true">
                ...
                <div className="mt-22 cursor-pointer flex justify-center items-center">
                    ...
                    <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="67" height="16" fill="none" role="presentation" aria-label="Gorgias">
...
Chat.propTypes = {
  ...
  isChatOpen: PropTypes.bool.isRequired, // isChatOpen is a required boolean
  setIsChatOpen: PropTypes.func.isRequired, // setIsChatOpen is a required function
};
